            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="contato" value="{{ $empresa->contato }}"/>
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="form-group">
                        <label for="site">Site</label>
                        <input type="text" class="form-control" name="site" value="{{ $empresa->site }}"/>
                    </div>
                </div>
                <div class="col-md-5">
                    <div class="form-group">
                ...
                <div class="col-md-12 mt-3 mb-3">
                    <div class="form-group">
                        ...
                        <textarea name="observacao" id="observacao" cols="30" rows="10" class="form-control">{{ $empresa->observacao }}</textarea>
                    </div>
                </div>
                <div class="col-md-12">
                    <button type="submit" class="btn btn-block btn-success" style="width: 100%">Atualizar Empresa</button>
                </div>
            </div>
        </form>
